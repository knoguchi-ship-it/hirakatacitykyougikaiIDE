...
更新日: 2026-05-06
現行本番: `v308` / integrated-public GAS version `290` / member split GAS version `44` / admin split GAS version `68`
fixed deployment: integrated/public `@290` x2 / member split `@44` / admin split `@68`
...
| 管理者ポータル | admin split | `AKfycbwSCTTyvWY_cFG764XawdbqA8r0qxYbav4aDZ-BK9rRmvXHoUXrKQnQ9egRGqWcx4Os` | `DOMAIN` | `@68` |
...
2. `HANDOVER.md`、`docs/188_RELEASE_STATE_v305_2026-05-05.md`、`docs/09_DEPLOYMENT_POLICY.md` を読む。
