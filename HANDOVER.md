...
更新日: 2026-05-08
現行本番: `v317` / integrated-public GAS version `290` / member split GAS version `44` / admin split GAS version `77`
fixed deployment: integrated/public `@290` x2 / member split `@44` / admin split `@77`
...
| 管理者ポータル | admin split | `AKfycbwSCTTyvWY_cFG764XawdbqA8r0qxYbav4aDZ-BK9rRmvXHoUXrKQnQ9egRGqWcx4Os` | `DOMAIN` | `@77` |
