...
<nav class="topnav">
  ...
  <a href="er-editor.html">🛠️ ER エディタ(汎用)</a>
...
<section class="card">
  ...
  <div class="toc-grid">
    <a href="interactive-er.html"><div class="toc-card" style="border-left-color: #dc2626; background: linear-gradient(135deg, #fef2f2, #d9f3ef);">
      <h3>🔬 インタラクティブ ER ビューア</h3>
      <p><b>本案件専用</b>。React Flow + ELK で全カラム × 全テーブルをドラッグ可能。クリックで関連のみハイライト</p>
    </div></a>
    <a href="er-editor.html"><div class="toc-card" style="border-left-color: #f59e0b; background: linear-gradient(135deg, #fef3c7, #d9f3ef);">
      <h3>🛠️ ER エディタ &amp; ビューア(汎用ツール)</h3>
      <p><b>任意のスキーマ対応</b>。DBML / Mermaid をエディタで編集 → ライブプレビュー。ファイル読込/保存/D&amp;D 対応</p>
    </div></a>
