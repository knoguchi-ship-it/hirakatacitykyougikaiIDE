...
| [253_RELEASE_STATE_v376.61_2026-09-02.md](253_RELEASE_STATE_v376.61_2026-09-02.md) | v376.61 研修 endTime 実害バグ是正（リリース済 @366×2/@125/@222）＋課題B/C の申し送り |
| [254_RELEASE_STATE_v376.62_2026-09-02.md](254_RELEASE_STATE_v376.62_2026-09-02.md) | v376.62 テンプレート一覧取得失敗の是正・build pruner 到達性の根本修正・未定義参照 gate 新設（リリース済 @367×2/@126/@223） |
