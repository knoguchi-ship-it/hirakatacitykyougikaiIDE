...
| [274_RELEASE_STATE_v376.81-88_2026-09-06.md](274_RELEASE_STATE_v376.81-88_2026-09-06.md) | **v376.87 一括保存の修正 ＋ v376.88 公開ポータルの本人確認を 3 種別へ（賛助会員の変更・退会を解禁）＋ ポータル 3 フローの実地検証** |
| [273_RELEASE_STATE_v376.80_2026-09-05.md](273_RELEASE_STATE_v376.80_2026-09-05.md) | **v376.80 dryrun.gs の棚卸し（38→19 ツール・51% 削減）＋ 文書の ID 整合検査（U-22 解消）** |
| [272_RELEASE_STATE_v376.78-79_2026-09-05.md](272_RELEASE_STATE_v376.78-79_2026-09-05.md) | **v376.78/.79 管理画面からのログインロック解除（SOW U-26 解消）＋ 段階的な待機の不具合修正** |
| [271_RELEASE_STATE_v376.74-77_2026-09-05.md](271_RELEASE_STATE_v376.74-77_2026-09-05.md) | **v376.74〜.77 入会申込に「注意事項」ステップを新設（会員種別ごとの案内）** |
