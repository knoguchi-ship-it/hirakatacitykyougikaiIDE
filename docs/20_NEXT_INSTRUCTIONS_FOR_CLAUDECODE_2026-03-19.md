...
- ブランチ: `main`
- 最新本番反映: `v144`（管理者フィールド編集オーバーライド + ダッシュボード在籍会員のみカウント）
...
- 本番固定 Deployment:
  - 会員マイページ: `AKfycbywpWoYxij6A-ZunIeBjG1Q8qX78PMMTsT3frx1cM5PJ2nAuZpz81KruXb5LIvWgbQx` → `@144`
  - 公開ポータル: `AKfycbxyuUXgK1oHUDMahQjluiL-gcrMK0qV0FWLFYaYBqGxlRSg9NhvmbyQRyf0dvaqg7Zp` → `@144`
  - Apps Script UI の説明名: `会員メニュー (prod) v144 admin override + active dashboard` / `公開ポータル (prod) v144 admin override + active dashboard`
