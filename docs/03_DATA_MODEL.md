...
| バージョン | 日付 | 変更概要 |
|---|---|---|
| 2026-03-27-01 | 2026-03-27 | T_事業所職員に `メール配信希望コード` を追加（v133。特定電子メール法オプトイン準拠、デフォルト YES） |
| 2026-03-26-04 | 2026-03-26 | T_会員の会員種別別フィールド制約を明文化（事業所会員の姓/名/セイ/メイ/CM番号/発送方法/郵送先をブランク運用） |
| 2026-03-26-03 | 2026-03-26 | T_事業所職員に `姓/名/セイ/メイ` を追加、`_CREDENTIALS_TEMP` 運用を追加、内部 `_BAK_*` 依存を外部バックアップ前提へ整理 |
| 2026-03-24-01 | 2026-03-24 | T_会員に退会処理日を追加（退会手続き実施日。退会日は年度末3/31を自動計算） |
