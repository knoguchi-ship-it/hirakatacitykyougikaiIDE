...
- `v294`: mailing-list export admin UI renames the annual fee column label to `年会費納入`, defaults target selection to none after loading, and removes emphasis color from the `表示中を選択` button.
...
1. `HANDOVER.md`
2. `AGENTS.md`
3. `docs/176_RELEASE_STATE_v294_2026-05-03.md`
4. `docs/175_RELEASE_STATE_v293_2026-05-03.md`
5. `docs/174_RELEASE_STATE_v292_2026-05-01.md`
6. `docs/173_RELEASE_STATE_v291_2026-05-01.md`
7. `docs/169_RELEASE_STATE_v290_2026-04-29.md`
8. `docs/168_RELEASE_STATE_v289_2026-04-29.md`
9. `docs/167_THIRD_PARTY_ASSESSMENT_PUBLIC_SEPARATION_2026-04-28.md`
10. `docs/165_HANDOVER_PUBLIC_PORTAL_SEPARATION_PLAN_2026-04-28.md`
...
- Admin is currently stable at `@51`.

Recommended approach:

1. Diff any future pruning candidate against the current stable admin artifact `@51` and the historical failed `@47` output if needed.
...
- `npx clasp deployments --json`: integrated/public `@290` × 2, member `@40`, admin `@51`
...
- Browser functional confirmation for v294 admin mailing-list workflow and password flows remains operator confirmation.
