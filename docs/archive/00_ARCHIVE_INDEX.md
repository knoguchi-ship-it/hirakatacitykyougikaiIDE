...
## リリース記録 — `release_history/`（169 件・実測）

各リリースの詳細（バージョン・スコープ・検証・ロールバック先）。時系列の要約は `docs/release-notes-2026.md` にあるので、個別の詳細が要るときだけ開く。

| 新しいもの順 |
|---|
| [283_RELEASE_STATE_v376.97_2026-09-22.md](release_history/283_RELEASE_STATE_v376.97_2026-09-22.md) |
...
| [278_RELEASE_STATE_v376.92_2026-09-12.md](release_history/278_RELEASE_STATE_v376.92_2026-09-12.md) |
| [277_RELEASE_STATE_v376.91_2026-09-10.md](release_history/277_RELEASE_STATE_v376.91_2026-09-10.md) |
| [276_RELEASE_STATE_v376.90_2026-09-10.md](release_history/276_RELEASE_STATE_v376.90_2026-09-10.md) |
| [275_RELEASE_STATE_v376.89_2026-09-09.md](release_history/275_RELEASE_STATE_v376.89_2026-09-09.md) |
