...
export const MOCK_TRAININGS: Training[] = [
  {
    ...
    applicationCloseDate: '2026-02-14',
  ...
  },
  {
    ...
    inquiryContactValue: '072-000-1234',
    organizer: '枚方市介護支援専門員連絡協議会',
    instructor: '講師: 田村 花',
  ...
  },
  {
    ...
    inquiryContactType: 'EMAIL',
    inquiryContactValue: 'kenshu@example.com',
    organizer: '枚方市介護支援専門員連絡協議会',
    instructor: '講師: 中村 友美',
    applicationOpenDate: '2026-03-01',
    applicationCloseDate: '2026-04-12',
    fees: [{ label: '会員', amount: 1000 }, { label: '非会員', amount: 4000 }],
  },
  {
    id: 'T004',
    ...
    inquiryContactType: 'PHONE',
    inquiryContactValue: '072-111-2222',
    organizer: '枚方市介護支援専門員連絡協議会',
    instructor: '講師: 川口 誠',
    applicationOpenDate: '2026-03-15',
    applicationCloseDate: '2026-05-02',
    fees: [{ label: '会員', amount: 0 }, { label: '非会員', amount: 2000 }],
  },
];
